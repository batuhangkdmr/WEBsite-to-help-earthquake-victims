...
<body>
    ...
    <div class="topnav" id="myTopnav">
        ...
        <a href="#hakkimizda">Disaster Relief Organizations</a>
    ...
    <section>
        <div id="yardım">
            ...
            <div>
                <h4 class="baslikk">For Those Who Want to Help</h4>
                <a href="#" class="dd">Donation Links</a>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td data-label="Account">KIZILAY</td>
                         
                            <td><a href="https://www.kizilay.org.tr/bagis" target="_blank" class="dds">Link</a></td>
                        </tr>
                           <tr>
                            <td data-label="Account">AFAD</td>
                            
                            <td><a href="https://www.afad.gov.tr/depremkampanyasi2" target="_blank" class="dds">Link</a></td>
                        </tr>
                           <tr>
                            <td data-label="Account">AHBAP</td>
                      
                            <td><a href="https://ahbap.org/bagisci-ol" target="_blank" class="dds">Link</a></td>
                        </tr>
                ...
                <h3>last update Date: <time datetime="2023-05-13T12:00:00Z">07:05:2023 02:35</time></h3>
            </div>
        </div>
    </section>
